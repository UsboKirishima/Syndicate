...
namespace NETWORK
{
	...
	static bool NETWORK_IS_HANDLE_VALID(int *p0, int p1) { return invoke<Any>(0xF0996C6E, p0, p1); } // 0xF0996C6E
	...
	static bool NETWORK_IS_FRIEND(int *player) { return invoke<Any>(0x2DA4C282, player); } // 0x2DA4C282
